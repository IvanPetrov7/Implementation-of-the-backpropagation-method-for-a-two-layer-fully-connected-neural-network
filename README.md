...
└── test/
    ├── 0/    # Изображения 0 для тестирования
    ├── 1/    # Изображения 1 для тестирования
    ├── 2/    # Изображения 2 для тестирования
    ├── 3/    # Изображения 3 для тестирования
    ├── 4/    # Изображения 4 для тестирования
    ├── 5/    # Изображения 5 для тестирования
    ├── 6/    # Изображения 6 для тестирования
    ├── 7/    # Изображения 7 для тестирования
    ├── 8/    # Изображения 8 для тестирования
    └── 9/    # Изображения 9 для тестирования
```
